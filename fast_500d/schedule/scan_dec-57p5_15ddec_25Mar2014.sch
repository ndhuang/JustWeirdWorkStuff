...
# 
# Thus in this file, DEl = 9.05 arcmin, so nEl_dither = 19.  The size of
...
#
#    scan_63p1degrees_dec-65_25Mar2014.sch([source], 0, 1, true)
#
#ESCH_DOC
#=======================================================================
...
FieldObservation fastScan = {daz_63p1-2p2ds-2p0dss-9p1ams, 108, -33.935001, -8.15, 0.00833333, 19}
...
command scan_field_el57p5_2014(Source target, FieldObservation obs, Integer iEl_dither) {
  ...
  PointingOffset testAZ = 98.0 # max_az from scan + 2 hrs ob time * 15 deg/hr

  acquire_source($target)
  offset/add az=-$obs.azOffset
  until $acquired(source)
...
do Count map_index=1,$nmaps,1 {
  do Integer iEl_dither=$iElStart,$iElStop,1 {
    #----------------------------------------------------------
