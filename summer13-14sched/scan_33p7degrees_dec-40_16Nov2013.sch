...
#=======================================================================
#SSCH_DOC
# Schedule to do a simple scan of a 2h x 10 degree field at dec=-45
#
#                                                              ___  
...
# nEl_dither so that your effective El sampling is the size of one pixel
# on the sky, or 1 arcmin:
# 
#     nEl_dither = (elevation step) / 1 arcmin
# 
# Thus in this file, DEl = 6 arcmin, so nEl_dither = 6.  The size of
...
#
#    scan_31p4degrees_dec-45_20aug2010.sch([source], 2, 0, true)
#
#ESCH_DOC
#=======================================================================
...
FieldObservation fastScan = {daz-33p7-0p60ds-2p0dss-9p7ams.scan, 70, -16.870692, -5.65, 0.00833333, 19}
