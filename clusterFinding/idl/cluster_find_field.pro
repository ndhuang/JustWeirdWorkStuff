...
;; weight_coadd, field_dir, runlist, freqs[i]
;; make_psd, field_dir, freqs[i], /usemem
;; noise_uk, field_dir, freqs[i], texfile=main_tex, npix=npix

;; make_clusterlist_catalog_sptpol, field_dir, field, radec0, ptsrcfile
cluster_list_summary, field_dir + '/cluster_out/new/clusters_3-sigma.sav', texsummary, textsummary, radec0, field
exit
