pro map_cuts2, directory, junkfile=junkfile, weight_thresh=weight_thresh
  ...
  mapfiles = file_search(directory + '*090ghz.h5')
  ...
  save, cuts, filename=directory + 'map_cuts090ghz.sav'
  close, badmaps
end
